...
DialogFormTitle.displayName = DialogPrimitive.Title.displayName

const DialogFormDescription = React.forwardRef<
...
DialogFormDescription.displayName = DialogPrimitive.Description.displayName
